...
## Viikko 2 (4 h)
- 4 h (vaatimusmääritelmän luonti + Github)

## Viikko 3 (31 h)
- 31 h (JavaFX testailua, raakaversion toteutus, koodin parannuksia, testien tekeminen)

## Viikko 4 (15 h)
- 1 h (pelilogiikan ja grafiikan erotus, osa 1)
- 4 h (refaktotointia)
- 1 h (muutama testi)
...
- 1 h suunnittelua
- 2 h testejä
- 3 h lisää ominaisuuksia (mm. bonus- ja aloituruutunäkymät)
- 1 h dokumentointi yms

## Viikko 6 (11 h)
- 3 h refaktorointia (eritelty grafiikka kokonaisuudessaan muusta koodista ja sama myös koskien Input-toimintoja)
- 2 h testejä
- 2 h lisää ominaisuuksia
- 1 h koodiparannuksia
